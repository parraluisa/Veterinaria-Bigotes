...
public class DbController implements ApplicationRunner {
    ...
    private void createVets() {
        ...
        saveUserVet(vet);
        // Crear veterinario 2
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612797L).firstName("Luis").firstLastName("Lopez").secondLastName("Rodriguez").password("5678").speciality("Dermatologo").imgUrl("https://images.pexels.com/photos/5407206/pexels-photo-5407206.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 3
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612798L).firstName("Carlos").firstLastName("Martinez").secondLastName("Perez").password("4321").speciality("Cardiologo").imgUrl("https://images.pexels.com/photos/5327921/pexels-photo-5327921.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 4
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612799L).firstName("Isabel").firstLastName("Gonzalez").secondLastName("Silva").password("9876").speciality("Oncologo").imgUrl("https://images.pexels.com/photos/6749778/pexels-photo-6749778.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 5
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612800L).firstName("Diego").firstLastName("Rodriguez").secondLastName("Lopez").password("2468").speciality("Neurologo").imgUrl("https://images.pexels.com/photos/5867730/pexels-photo-5867730.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 6
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612801L).firstName("Ana").firstLastName("Perez").secondLastName("Fernandez").password("1357").speciality("Radiologo").imgUrl("https://images.pexels.com/photos/5452201/pexels-photo-5452201.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 7
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612802L).firstName("Javier").firstLastName("Sanchez").secondLastName("Ramirez").password("8765").speciality("Radiologo").imgUrl("https://images.pexels.com/photos/5452291/pexels-photo-5452291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 8
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612803L).firstName("Sofia").firstLastName("Hernandez").secondLastName("Gomez").password("3691").speciality("Dentista").imgUrl("https://images.pexels.com/photos/12495583/pexels-photo-12495583.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 9
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612804L).firstName("Luis").firstLastName("Torres").secondLastName("Diaz").password("7412").speciality("Cirujano").imgUrl("https://images.pexels.com/photos/3279197/pexels-photo-3279197.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 10
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612805L).firstName("Elena").firstLastName("Fernandez").secondLastName("Molina").password("5824").speciality("Dentista").imgUrl("https://images.pexels.com/photos/4167541/pexels-photo-4167541.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build());
        // Crear veterinario 11
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612806L).firstName("Juan").firstLastName("Perez").secondLastName("Lopez").password("1234").speciality("Cirujano").imgUrl("https://images.pexels.com/photos/8460157/pexels-photo-8460157.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2").status("Activo").build());
        // Crear veterinario 12
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612807L).firstName("Laura").firstLastName("Garcia").secondLastName("Martinez").password("5678").speciality("Dermatologo").imgUrl("https://media.istockphoto.com/id/1227504152/es/foto/mujer-médico-llena-la-historia-clínica-y-escribe-receta-en-la-tableta.jpg?s=1024x1024&w=is&k=20&c=6znLs6DS5cgkYzUaeAy_2CnCLp962hklg9ts0Urzupg=").status("Activo").build());
        // Crear veterinario 13
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612808L).firstName("Pedro").firstLastName("Lopez").secondLastName("Rodriguez").password("4321").speciality("Cardiologo").imgUrl("https://images.pexels.com/photos/12660379/pexels-photo-12660379.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2").status("Activo").build());
        // Crear veterinario 14
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612809L).firstName("Carmen").firstLastName("Martinez").secondLastName("Gonzalez").password("9876").speciality("Oncologo").imgUrl("https://media.istockphoto.com/id/1249199278/es/foto/foto-de-perfil-de-atractiva-familia-doc-señora-pacientes-consulta-amigable-sonrisa-confiable.jpg?s=1024x1024&w=is&k=20&c=9_B0DyArRLvaVHcOy7w9AovzJI32wqLE7xs8sx80QIg=").status("Activo").build());
        // Crear veterinario 15
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612810L).firstName("Fernando").firstLastName("Gonzalez").secondLastName("Silva").password("2468").speciality("Neurologo").imgUrl("https://images.pexels.com/photos/6303591/pexels-photo-6303591.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2").status("Activo").build());
        // Crear veterinario 16
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612811L).firstName("Ana").firstLastName("Rodriguez").secondLastName("Fernandez").password("1357").speciality("Radiologo").imgUrl("https://media.istockphoto.com/id/1256122635/es/foto/retrato-de-primer-plano-de-bonito-atractivo-alegre-rubia-chica-doc-usando-gadget-conexión.jpg?s=1024x1024&w=is&k=20&c=3F3nAJiLOoDYJRjRk_HvWUfTenVICDtcHDZKRCpbLD4=").status("Activo").build());
        // Crear veterinario 17
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612812L).firstName("Miguel").firstLastName("Perez").secondLastName("Gomez").password("8765").speciality("Radiologo").imgUrl("https://media.istockphoto.com/id/1269486200/es/foto/apuesto-joven-médico-en-el-pasillo-del-hospital-mirando-a-la-cámara-sonriendo.jpg?s=1024x1024&w=is&k=20&c=_135u4a6GZGSC0Wo504yAsROExyhXRT_DrNwmXZvcsk=").status("Activo").build());
        // Crear veterinario 18
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612813L).firstName("Sara").firstLastName("Sanchez").secondLastName("Ramirez").password("3691").speciality("Dentista").imgUrl("https://media.istockphoto.com/id/1222193164/es/foto/concepto-de-consulta-médica-mujer-doctora-en-gafas-con-portátil.jpg?s=1024x1024&w=is&k=20&c=ZQVc8cuOu59NgKdWrWfVFk37TbNAiODV_5u1MFx8jp4=").status("Activo").build());
        // Crear veterinario 19
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612814L).firstName("Carlos").firstLastName("Torres").secondLastName("Diaz").password("7412").speciality("Cirujano").imgUrl("https://media.istockphoto.com/id/1593890881/es/foto/retrato-de-un-joven-médico-indio-parado-en-una-clínica-en-el-consultorio-del-hospital-con-una.jpg?s=1024x1024&w=is&k=20&c=rzTesU4kjlMg4LshoxI5MFfoZ8vVNmZ_AdcvMSQpiXk=").status("Activo").build());
        // Crear veterinario 20
        veterinarianRepository.save(Veterinarian.builder().idCard(1000612815L).firstName("Lorena").firstLastName("Fernandez").secondLastName("Molina").password("5824").speciality("Dentista").imgUrl("https://media.istockphoto.com/id/1436148451/es/foto/doctora-sonriente-con-tableta-digital-de-pie-sobre-fondo-gris-aislado.jpg?s=1024x1024&w=is&k=20&c=uTl86-Boiidyq0C_3hAzXrnBM1_lH5TsklT0Tp4ONMs=").status("Activo").build());
    }
