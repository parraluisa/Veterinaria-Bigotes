...
public class DbController implements ApplicationRunner {
    ...
    private void createVets() {
        Veterinarian vet;
        // Crear veterinario 1
        vet = Veterinarian.builder().idCard(1000612795L).firstName("Andrés").firstLastName("Garcia").secondLastName("Montoya").password("1234").speciality("Cirujano").imgUrl("https://images.pexels.com/photos/5327585/pexels-photo-5327585.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 2
        vet = Veterinarian.builder().idCard(1000612797L).firstName("Luis").firstLastName("Lopez").secondLastName("Rodriguez").password("5678").speciality("Dermatologo").imgUrl("https://images.pexels.com/photos/5407206/pexels-photo-5407206.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 3
        vet = Veterinarian.builder().idCard(1000612798L).firstName("Carlos").firstLastName("Martinez").secondLastName("Perez").password("4321").speciality("Cardiologo").imgUrl("https://images.pexels.com/photos/5327921/pexels-photo-5327921.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 4
        vet = Veterinarian.builder().idCard(1000612799L).firstName("Isabel").firstLastName("Gonzalez").secondLastName("Silva").password("9876").speciality("Oncologo").imgUrl("https://images.pexels.com/photos/6749778/pexels-photo-6749778.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 5
        vet = Veterinarian.builder().idCard(1000612800L).firstName("Diego").firstLastName("Rodriguez").secondLastName("Lopez").password("2468").speciality("Neurologo").imgUrl("https://images.pexels.com/photos/5867730/pexels-photo-5867730.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 6
        vet = Veterinarian.builder().idCard(1000612801L).firstName("Ana").firstLastName("Perez").secondLastName("Fernandez").password("1357").speciality("Radiologo").imgUrl("https://images.pexels.com/photos/5452201/pexels-photo-5452201.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 7
        vet = Veterinarian.builder().idCard(1000612802L).firstName("Javier").firstLastName("Sanchez").secondLastName("Ramirez").password("8765").speciality("Radiologo").imgUrl("https://images.pexels.com/photos/5452291/pexels-photo-5452291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 8
        vet = Veterinarian.builder().idCard(1000612803L).firstName("Sofia").firstLastName("Hernandez").secondLastName("Gomez").password("3691").speciality("Dentista").imgUrl("https://images.pexels.com/photos/12495583/pexels-photo-12495583.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 9
        vet = Veterinarian.builder().idCard(1000612804L).firstName("Luis").firstLastName("Torres").secondLastName("Diaz").password("7412").speciality("Cirujano").imgUrl("https://images.pexels.com/photos/3279197/pexels-photo-3279197.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 10
        vet = Veterinarian.builder().idCard(1000612805L).firstName("Elena").firstLastName("Fernandez").secondLastName("Molina").password("5824").speciality("Dentista").imgUrl("https://images.pexels.com/photos/4167541/pexels-photo-4167541.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 11
        vet = Veterinarian.builder().idCard(1000612806L).firstName("Juan").firstLastName("Perez").secondLastName("Lopez").password("1234").speciality("Cirujano").imgUrl("https://images.pexels.com/photos/8460157/pexels-photo-8460157.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 12
        vet = Veterinarian.builder().idCard(1000612807L).firstName("Laura").firstLastName("Garcia").secondLastName("Martinez").password("5678").speciality("Dermatologo").imgUrl("https://media.istockphoto.com/id/1227504152/es/foto/mujer-médico-llena-la-historia-clínica-y-escribe-receta-en-la-tableta.jpg?s=1024x1024&w=is&k=20&c=6znLs6DS5cgkYzUaeAy_2CnCLp962hklg9ts0Urzupg=").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 13
        vet = Veterinarian.builder().idCard(1000612808L).firstName("Pedro").firstLastName("Lopez").secondLastName("Rodriguez").password("4321").speciality("Cardiologo").imgUrl("https://images.pexels.com/photos/12660379/pexels-photo-12660379.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 14
        vet = Veterinarian.builder().idCard(1000612809L).firstName("Carmen").firstLastName("Martinez").secondLastName("Gonzalez").password("9876").speciality("Oncologo").imgUrl("https://media.istockphoto.com/id/1249199278/es/foto/foto-de-perfil-de-atractiva-familia-doc-señora-pacientes-consulta-amigable-sonrisa-confiable.jpg?s=1024x1024&w=is&k=20&c=9_B0DyArRLvaVHcOy7w9AovzJI32wqLE7xs8sx80QIg=").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 15
        vet = Veterinarian.builder().idCard(1000612810L).firstName("Fernando").firstLastName("Gonzalez").secondLastName("Silva").password("2468").speciality("Neurologo").imgUrl("https://images.pexels.com/photos/6303591/pexels-photo-6303591.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 16
        vet = Veterinarian.builder().idCard(1000612811L).firstName("Ana").firstLastName("Rodriguez").secondLastName("Fernandez").password("1357").speciality("Radiologo").imgUrl("https://media.istockphoto.com/id/1256122635/es/foto/retrato-de-primer-plano-de-bonito-atractivo-alegre-rubia-chica-doc-usando-gadget-conexión.jpg?s=1024x1024&w=is&k=20&c=3F3nAJiLOoDYJRjRk_HvWUfTenVICDtcHDZKRCpbLD4=").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 17
        vet = Veterinarian.builder().idCard(1000612812L).firstName("Miguel").firstLastName("Perez").secondLastName("Gomez").password("8765").speciality("Radiologo").imgUrl("https://media.istockphoto.com/id/1269486200/es/foto/apuesto-joven-médico-en-el-pasillo-del-hospital-mirando-a-la-cámara-sonriendo.jpg?s=1024x1024&w=is&k=20&c=_135u4a6GZGSC0Wo504yAsROExyhXRT_DrNwmXZvcsk=").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 18
        vet = Veterinarian.builder().idCard(1000612813L).firstName("Sara").firstLastName("Sanchez").secondLastName("Ramirez").password("3691").speciality("Dentista").imgUrl("https://media.istockphoto.com/id/1222193164/es/foto/concepto-de-consulta-médica-mujer-doctora-en-gafas-con-portátil.jpg?s=1024x1024&w=is&k=20&c=ZQVc8cuOu59NgKdWrWfVFk37TbNAiODV_5u1MFx8jp4=").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 19
        vet = Veterinarian.builder().idCard(1000612814L).firstName("Carlos").firstLastName("Torres").secondLastName("Diaz").password("7412").speciality("Cirujano").imgUrl("https://media.istockphoto.com/id/1593890881/es/foto/retrato-de-un-joven-médico-indio-parado-en-una-clínica-en-el-consultorio-del-hospital-con-una.jpg?s=1024x1024&w=is&k=20&c=rzTesU4kjlMg4LshoxI5MFfoZ8vVNmZ_AdcvMSQpiXk=").status("Activo").build();
        saveUserVet(vet);
        // Crear veterinario 20
        vet = Veterinarian.builder().idCard(1000612815L).firstName("Lorena").firstLastName("Fernandez").secondLastName("Molina").password("5824").speciality("Dentista").imgUrl("https://media.istockphoto.com/id/1436148451/es/foto/doctora-sonriente-con-tableta-digital-de-pie-sobre-fondo-gris-aislado.jpg?s=1024x1024&w=is&k=20&c=uTl86-Boiidyq0C_3hAzXrnBM1_lH5TsklT0Tp4ONMs=").status("Activo").build();
        saveUserVet(vet);
    }
    ...
    private void createOwners() {
        // Create owner 1
        saveUserOwner(
                new Owner(1001298925L, "Esteban", "Gómez", "Buitrago", "3116721345", "esteban.buitrago@gmail.com"));
        // Create owner 2
        ...
        // Create owner 6
        saveUserOwner(new Owner(678901234L, "Pablo", "Andro", "Hulca", "5551344", "hulca@exaple.com"));
        // Create owner 7
        saveUserOwner(new Owner(789012345L, "Nathalie", "Hurtado", "Rojas", "7872432", "nathur@example.com"));
        // Create owner 8
        saveUserOwner(new Owner(890123456L, "Nashly", "Valto", "Torres", "4323555", "nash@example.com"));
        // Create owner 9
        saveUserOwner(new Owner(901234567L, "Janeth", "Cantero", "Gil", "9855432", "cantja@example.com"));
        // Create owner 10
        saveUserOwner(new Owner(987654321L, "Enrrique", "Maldonado", "Polo", "9873748", "enrri@example.com "));
        // Create owner 11
        saveUserOwner(new Owner(876543210L, "Eduardo", "Cruz", "Bolivar", "8752333", "eduardo@example.com"));
        // Create owner 12
        saveUserOwner(new Owner(765432109L, "María", "Morales", "Rivera", "3225800", "mam@gmail.com"));
        // Create owner 13
        saveUserOwner(new Owner(654321098L, "Miguel", "Uribe", "Velez", "3238876", "migue@example.com"));
        // Create owner 14
        saveUserOwner(new Owner(543210987L, "Raul", "Nivia", "Velez", "3238888", "rau@example.com"));
        // Create owner 15
        saveUserOwner(new Owner(432109876L, "Nelson", "Jimenez", "Alteri", "3230374", "neljia@example.com"));
        // Create owner 16
        saveUserOwner(new Owner(210987654L, "Jimena", "Alvarez", "Estrada", "3237483", "jimeal@example.com"));
        // Create owner 17
        saveUserOwner(new Owner(339527439L, "Alberto", "Nuñez", "Navarro", "6464316", "AlNuNa@example.com"));
        // create owner 18
        saveUserOwner(new Owner(389629107L, "Alejandra", "Alvarez", "Chaparro", "7634480", "AlAlCh@example.com"));
        // create owner 19
        saveUserOwner(new Owner(625390588L, "Paula", "Ortega", "Parra", "3228670", "PaOrPa@example.com"));
        // create owner 20
        saveUserOwner(new Owner(854299681L, "Luis", "Silva", "Bustos", "7841868", "LuSiBu@example.com"));
        // create owner 21
        saveUserOwner(new Owner(996211128L, "Alex", "Sanchez", "Galvis", "3005175", "AlSaGa@example.com"));
        // create owner 22
        saveUserOwner(new Owner(813299857L, "Sebastian", "Alvarez", "Parada", "5106842", "SeAlPa@example.com"));
        // create owner 23
        saveUserOwner(new Owner(542045102L, "Sara", "Castro", "Peña", "4724792", "SaCaPe@example.com"));
        // create owner 24
        saveUserOwner(new Owner(378517623L, "Sara", "Linares", "Fuentes", "9073534", "SaLiFu@example.com"));
        // create owner 25
        saveUserOwner(new Owner(420390569L, "Circe", "Castillo", "Salas", "1639592", "CiCaSa@example.com"));
        // create owner 26
        saveUserOwner(new Owner(936618990L, "Andres", "Castillo", "Restrepo", "1243110", "AnCaRe@example.com"));
        // create owner 27
        saveUserOwner(new Owner(455807491L, "Lety", "Rojas", "Chaparro", "4018208", "LeRoCh@example.com"));
        // create owner 28
        saveUserOwner(new Owner(321227151L, "Alex", "Romero", "Zuñiga", "1299908", "AlRoZu@example.com"));
        // create owner 29
        saveUserOwner(new Owner(892201172L, "Sara", "Parada", "Salas", "7293452", "SaPaSa@example.com"));
        // create owner 30
        saveUserOwner(new Owner(560136473L, "Alejandro", "Gonzalez", "Ahumada", "6444285", "AlGoAh@example.com"));
        // create owner 31
        saveUserOwner(new Owner(804999127L, "Nashly", "Silva", "Castillo", "4248438", "NaSiCa@example.com"));
        // create owner 32
        saveUserOwner(new Owner(510972620L, "Jane", "Molina", "Lara", "7466902", "JaMoLa@example.com"));
        // create owner 33
        saveUserOwner(new Owner(475470342L, "Enrrique", "Linares", "Castrillon", "7522873", "EnLiCa@example.com"));
        // create owner 34
        saveUserOwner(new Owner(580071667L, "Juan", "Castro", "Zuñiga", "2646743", "JuCaZu@example.com"));
        // create owner 35
        saveUserOwner(new Owner(257138356L, "Sofia", "Vasquez", "Restrepo", "8728577", "SoVaRe@example.com"));
        // create owner 36
        saveUserOwner(new Owner(966440715L, "Nashly", "Castro", "Peña", "7943177", "NaCaPe@example.com"));
        // create owner 37
        saveUserOwner(new Owner(124226767L, "Alberto", "Gómez", "Campos", "3457259", "AlGóCa@example.com"));
        // create owner 38
        saveUserOwner(new Owner(698247603L, "Alejandro", "Alvarez", "Mendez", "4162734", "AlAlMe@example.com"));
        // create owner 39
        saveUserOwner(new Owner(378490151L, "Alejandro", "Lopez", "Campos", "1636449", "AlLoCa@example.com"));
        // create owner 40
        saveUserOwner(new Owner(821559054L, "María", "Romero", "Ahumada", "4374921", "MaRoAh@example.com"));
        // create owner 41
        saveUserOwner(new Owner(640537211L, "Sebastian", "Morales", "Restrepo", "7952017", "SeMoRe@example.com"));
        // create owner 42
        saveUserOwner(new Owner(938522664L, "Fernanda", "Silva", "Paredes", "9301132", "FeSiPa@example.com"));
        // create owner 43
        saveUserOwner(new Owner(258352672L, "Erick", "Fernandez", "Chaparro", "3983051", "ErFeCh@example.com"));
        // create owner 44
        saveUserOwner(new Owner(146073939L, "Oswaldo", "Linares", "Montoya", "4691450", "OsLiMo@example.com"));
        // create owner 45
        saveUserOwner(new Owner(883159347L, "Alberto", "Buitrago", "Guerrero", "9776421", "AlBuGu@example.com"));
        // create owner 46
        saveUserOwner(new Owner(661240045L, "Camilo", "Aguilar", "Cortes", "4661696", "CaAgCo@example.com"));
        // create owner 47
        saveUserOwner(new Owner(517987000L, "Nathalie", "Silva", "Campos", "6793730", "NaSiCam@example.com"));
        // create owner 48
        saveUserOwner(new Owner(572035520L, "Janeth", "Cabrera", "Miranda", "3305345", "JaCaMi@example.com"));
        // create owner 49
        saveUserOwner(new Owner(167717438L, "Paula", "Hernandez", "Cortez", "1098594", "PaHeCo@example.com"));
        // create owner 50
        saveUserOwner(new Owner(511947917L, "Eduardo", "Castillo", "Cortez", "2316386", "EdCaCo@example.com"));
        // create owner 51
        saveUserOwner(new Owner(846422107L, "Sara", "Rodriguez", "Valencia", "9981032", "SaRoVa@example.com"));
        // create owner 52
        saveUserOwner(new Owner(210241221L, "Sara", "Castro", "Lara", "2584197", "SaCaLa@example.com"));
        // create owner 53
        saveUserOwner(new Owner(110619556L, "Sebastian", "Fernandez", "Mendoza", "2278777", "SeFeMe@example.com"));
        // create owner 54
        saveUserOwner(new Owner(634672894L, "Camilo", "Rojas", "Chavez", "7865377", "CaRoCh@example.com"));
        // create owner 55
        saveUserOwner(new Owner(975570482L, "Kevin", "Perez", "Torres", "8259213", "KePeTo@example.com"));
        // create owner 56
        saveUserOwner(new Owner(547961919L, "Nathalie", "Castillo", "Aguilar", "3935301", "NaCaAg@example.com"));
        // create owner 57
        saveUserOwner(new Owner(829169492L, "Oswaldo", "Hernandez", "Pinto", "4819985", "OsHePi@example.com"));
        // create owner 58
        saveUserOwner(new Owner(549243502L, "Nathalie", "Ramirez", "Campos", "9388464", "NaRaCa@example.com"));
        // create owner 59
        saveUserOwner(new Owner(196416649L, "Alejandra", "Silva", "Valencia", "9822918", "AlSiVa@example.com"));
        // create owner 60
        saveUserOwner(new Owner(567352636L, "Sebastian", "Gomez", "Restrepo", "4602777", "SeGoRe@example.com"));
        // create owner 61
        saveUserOwner(new Owner(798173831L, "Pablo", "Rodriguez", "Parada", "7579155", "PaRoPa@example.com"));
        // create owner 62
        saveUserOwner(new Owner(655985260L, "John", "Romero", "Peña", "7391355", "JoRoPe@example.com"));
        // create owner 63
        saveUserOwner(new Owner(455935310L, "Luis", "Linares", "Chavez", "9025652", "LuLiCh@example.com"));
        // create owner 64
        saveUserOwner(new Owner(657949991L, "Alberto", "Ruiz", "Ahumada", "7569365", "AlRuAh@example.com"));
        // create owner 65
        saveUserOwner(new Owner(984312956L, "Oswaldo", "Ramirez", "Lara", "3372955", "OsRaLa@example.com"));
        // create owner 66
        saveUserOwner(new Owner(539264339L, "Sandra", "Rojas", "Sepulveda", "7499509", "SaRoSe@example.com"));
        // create owner 67
        saveUserOwner(new Owner(677979915L, "Circe", "Linares", "Torres", "5744770", "CiLiTo@example.com"));
        // create owner 68
        saveUserOwner(new Owner(622637951L, "Oswaldo", "Rodriguez", "Chaparro", "6573517", "OsRoCh@example.com"));
        // create owner 69
        saveUserOwner(new Owner(136989434L, "Pedro", "Vargas", "Chavez", "9301463", "PeVaCh@example.com"));
        // create owner 70
        saveUserOwner(new Owner(890223436L, "Nathalie", "Castro", "Paredes", "6412083", "NaCaPa@example.com"));
        // create owner 71
        saveUserOwner(new Owner(149819435L, "Lety", "Parada", "Valencia", "9386544", "LePaVa@example.com"));
        // create owner 72
        saveUserOwner(new Owner(283639477L, "Luis", "Torres", "Aguilar", "6408054", "LuToAg@example.com"));
        // create owner 73
        saveUserOwner(new Owner(198897671L, "María", "Ramirez", "Sepulveda", "9689679", "MaRaSe@example.com"));
        // create owner 74
        saveUserOwner(new Owner(316420753L, "Pedro", "Castillo", "Cortes", "3008839", "PeCaCo@example.com"));
        // create owner 75
        saveUserOwner(new Owner(407918405L, "Javier", "Aguilar", "Lara", "8883505", "JaAgLa@example.com"));
        // create owner 76
        saveUserOwner(new Owner(587267274L, "Andres", "Perez", "Chavez", "4644344", "AnPeCh@example.com"));
        // create owner 77
        saveUserOwner(new Owner(441949057L, "Alberto", "Linares", "Paredes", "4267491", "AlLiPa@example.com"));
        // create owner 78
        saveUserOwner(new Owner(310161583L, "Nashly", "Lopez", "Guerrero", "2603706", "NaLoGu@example.com"));
        // create owner 79
        saveUserOwner(new Owner(605919683L, "Eduardo", "Gomez", "Restrepo", "6495981", "EdGoRe@example.com"));
        // create owner 80
        saveUserOwner(new Owner(463325005L, "Fernanda", "Castillo", "Guerrero", "7491092", "FeCaGu@example.com"));
        // create owner 81
        saveUserOwner(new Owner(269631169L, "Valentina", "Gomez", "Guerrero", "7542338", "VaGoGu@example.com"));
        // create owner 82
        saveUserOwner(new Owner(859507885L, "Fernanda", "Jimenez", "Mendez", "4834142", "FeJiMe@example.com"));
        // create owner 83
        saveUserOwner(new Owner(821776320L, "Paula", "Fernandez", "Navarro", "4576609", "PaFeNa@example.com"));
        // create owner 84
        saveUserOwner(new Owner(265561323L, "Javier", "Martinez", "Parada", "4846325", "JaMaPa@example.com"));
        // create owner 85
        saveUserOwner(new Owner(261740316L, "Jane", "Castillo", "Castillo", "6524985", "JaCaCa@example.com"));
        // create owner 86
        saveUserOwner(new Owner(736308868L, "Lety", "Lopez", "Vergara", "1892702", "LeLoVe@example.com"));
        // create owner 87
        saveUserOwner(new Owner(633532182L, "John", "Buitrago", "Poblete", "3931417", "JoBuPo@example.com"));
        // create owner 88
        saveUserOwner(new Owner(505348574L, "Ana", "Guevara", "Bustos", "4461792", "AnGuBu@example.com"));
        // create owner 89
        saveUserOwner(new Owner(519433567L, "Lina", "Cabrera", "Poblete", "9758363", "LiCaPo@example.com"));
        // create owner 90
        saveUserOwner(new Owner(171713906L, "Ana", "Castillo", "Cruz", "5738941", "AnCaCr@example.com"));
        // create owner 91
        saveUserOwner(new Owner(803775996L, "Alejandra", "Gonzalez", "Araya", "4202395", "AlGoAr@example.com"));
        // create owner 92
        saveUserOwner(new Owner(322812909L, "Luis", "Ramirez", "Mendoza", "1993433", "LuRaMe@example.com"));
        // create owner 93
        saveUserOwner(new Owner(999815923L, "Eduardo", "Garcia", "Rivas", "3187199", "EdGaRi@example.com"));
        // create owner 94
        saveUserOwner(new Owner(883499951L, "Valentina", "Nuñez", "Pardo", "9829251", "VaNuPa@example.com"));
        // create owner 95
        saveUserOwner(new Owner(322472122L, "Andres", "Sanchez", "Parra", "1147552", "AnSaPa@example.com"));
        // create owner 96
        saveUserOwner(new Owner(119668984L, "Juliana", "Silva", "Miranda", "4185874", "JuSiMi@example.com"));
        // create owner 97
        saveUserOwner(new Owner(225991741L, "Oswaldo", "Castro", "Fuentes", "3826947", "OsCaFu@example.com"));
        // create owner 98
        saveUserOwner(new Owner(705030352L, "Pablo", "Alvarez", "Salas", "3762996", "PaAlSa@example.com"));
        // create owner 99
        saveUserOwner(new Owner(235716052L, "Valentina", "Castillo", "Araya", "1514406", "VaCaAr@example.com"));
        // create owner 100
        saveUserOwner(new Owner(646094641L, "Ana", "Ortega", "Paredes", "5902212", "AnOrPa@example.com"));
    }
